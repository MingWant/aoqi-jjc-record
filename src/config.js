...
export function loadConfig(overrides = {}) {
  ...
  const config = {
    ...
    rankingStabilityMinutes: integer("ARENA_RANKING_STABILITY_MINUTES", 60, 0),
    settlementGraceMinutes: integer("ARENA_SETTLEMENT_GRACE_MINUTES", 3, 0),
    snapshotRetentionDays: integer("ARENA_SNAPSHOT_RETENTION_DAYS", 30, 0),
...
export function publicConfig(config) {
  return {
    ...
    rankingStabilityMinutes: config.rankingStabilityMinutes,
